...
# Labels 
region_labs <- unique(data$region); names(region_labs) <- 1:length(region_labs)
koppen_labs <- unique(data$koppen); names(koppen_labs) <- 1:length(koppen_labs)
koppen_lvl1_labs <- unique(data$koppen_lvl1); names(koppen_lvl1_labs) <- 1:length(koppen_lvl1_labs)
koppen_mixed1_labs <- unique(data$koppen_mixed1); names(koppen_mixed1_labs) <- 1:length(koppen_mixed1_labs)
koppen_mixed2_labs <- unique(data$koppen_mixed2); names(koppen_mixed2_labs) <- 1:length(koppen_mixed2_labs)
```
