...
These are the 5 supra regions we will use for visualizations:

```{r health map}
plot_map(dengue_data, var = "region_id", 
         time = "date", area = "regional_geocode",
         map = healthreg, map_area = "regional_geocode", by_year = FALSE)
```
...
dengue_data |> 
  plot_timeseries(type = "cov", time = "date", area = "regional_geocode",
                  var = "tasan1", pop = "pop", aggregate_space = "uf",
...
dengue_data |> 
  plot_timeseries(type = "cov", time = "date", area = "regional_geocode",
                  var = "spi1", pop = "pop", aggregate_space = "uf",
