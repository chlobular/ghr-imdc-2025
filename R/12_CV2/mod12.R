...
fe_lsl <- paste(cov_varying("v1", "koppen_id", ""),
                ...
                sep = " + ")
fe_other <- cov_varying("time_id", pattern = "", unit = "region_id")

# 4. Fit ----

(f12 <- paste("", fe_lsl, fe_other, re_s_norep, re_w, sep = " + "))
sprint_mod(f12, data, "output/CV2", "mod12", eval_train = FALSE, eval_test = TRUE)