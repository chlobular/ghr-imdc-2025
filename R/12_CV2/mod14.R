...
fe_lsl <- paste(cov_varying("v1", "koppen_id", ""),
                ...
                sep = " + ")
fe_other <- cov_varying("tas6.l1", "koppen_id8", "")

# 4. Fit ----

(f14 <- paste("", fe_lsl, fe_other, re_s_norep, re_w, re_y, sep = " + "))
sprint_mod(f14, data, "output/CV2", "mod14", eval_train = FALSE, eval_test = TRUE)