...
data$region_id4 <- data$region_id
data$region_id5 <- data$region_id
data$region_id6 <- data$region_id
data$region_id7 <- data$region_id
data$region_id8 <- data$region_id
...
# 3. FE ----
fe_lsl <- paste(cov_varying("v1", "region_id", ""),
                cov_varying("v2", "region_id2", ""),
                cov_varying("v3", "region_id3", ""),
                cov_varying("v1v2", "region_id4", ""),
                cov_varying("v1v3", "region_id5", ""),
                cov_varying("v2v3", "region_id6", ""),
                cov_varying("v1v2v3", "region_id7", ""),
                sep = " + ")

# 4. Fit ----

(f13 <- paste("", fe_lsl, re_s_norep, re_w, sep = " + "))
sprint_mod(f13, data, "output/CV2", "mod13", eval_train = FALSE, eval_test = TRUE)