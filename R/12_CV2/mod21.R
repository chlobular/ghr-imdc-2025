...
fe_lsl <- paste(cov_varying("v1", "koppen_id", ""),
                ...
                sep = " + ")
fe_other <- cov_nl("oni.l6", pattern = "", method = "cut")[[1]]

# 4. Fit ----

(f21 <- paste("", fe_lsl, fe_other, re_s_norep, re_w, re_y, sep = " + "))
sprint_mod(f21, data, "output/CV2", "mod21", eval_train = FALSE, eval_test = TRUE)