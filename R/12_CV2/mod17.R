...
fe_lsl <- paste(cov_varying("v1", "koppen_id", ""),
                ...
                sep = " + ")
fe_other <- cov_varying("oni.l2", "region_id", "")

# 4. Fit ----

(f17 <- paste("", fe_lsl, fe_other, re_s_norep, re_w, re_y, sep = " + "))
sprint_mod(f17, data, "output/CV2", "mod17", eval_train = FALSE, eval_test = TRUE)