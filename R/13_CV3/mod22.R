...
sprint_eval(form_fit, data, "output/CV3", "mod22_2020", 2020); gc()
sprint_eval(form_fit, data, "output/CV3", "mod22_2021", 2021); gc()
sprint_eval(form_fit, data, "output/CV3", "mod22_2022", 2022); gc()
sprint_eval(form_fit, data, "output/CV3", "mod22_2023", 2023); gc()
sprint_eval(form_fit, data, "output/CV3", "mod22_2024", 2024); gc()
