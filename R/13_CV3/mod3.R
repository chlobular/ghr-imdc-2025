...
# 4. Fit ----
(form_fit <- paste("", re_s, re_w, re_y, sep = " + "))
sprint_eval(form_fit, data, "output/CV3", "mod3_2020", 2020); gc()
sprint_eval(form_fit, data, "output/CV3", "mod3_2021", 2021); gc()
sprint_eval(form_fit, data, "output/CV3", "mod3_2022", 2022); gc()
sprint_eval(form_fit, data, "output/CV3", "mod3_2023", 2023); gc()
sprint_eval(form_fit, data, "output/CV3", "mod3_2024", 2024); gc()
