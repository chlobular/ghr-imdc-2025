...
# 4. Fit ----
(form_fit <- paste("", re_s, re_w, sep = " + "))
sprint_eval(form_fit, data, "output/CV3", "mod1_2020", 2020); gc()
sprint_eval(form_fit, data, "output/CV3", "mod1_2021", 2021); gc()
sprint_eval(form_fit, data, "output/CV3", "mod1_2022", 2022); gc()
sprint_eval(form_fit, data, "output/CV3", "mod1_2023", 2023); gc()
sprint_eval(form_fit, data, "output/CV3", "mod1_2024", 2024); gc()
