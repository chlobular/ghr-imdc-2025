...
# 
# Description:
#     Fit model in validation 1 dataset
# 
# Script authors:
...
# Read data
data <- read.csv("data/processed/dataset_val1.csv")
dataset_var <- "validation_1"
...
mod <- ghr_predict(formula = form_fit,
                   ...
                   nsamples = 500)
saveRDS(mod, "output/mod_final/validation1_mod.rds")
...
saveRDS(stats, "output/mod_final/validation1_stats.rds")

# Predictions
states <- predict_states("output/mod_final/validation1_mod.rds", data, dataset_var) 
write.csv(states, "output/mod_final/validation1_states.csv", row.names = FALSE)
country <- predict_country("output/mod_final/validation1_mod.rds", data, dataset_var) 
write.csv(country, "output/mod_final/validation1_country.csv", row.names = FALSE)
