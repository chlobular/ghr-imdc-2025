...
# 
# Description:
#     Fit model in validation 2 dataset
# 
# Script authors:
...
# Read data
data <- read.csv("data/processed/dataset_val2.csv")
dataset_var <- "validation_2"
...
mod <- ghr_predict(formula = form_fit,
                   ...
                   nsamples = 500)
saveRDS(mod, "output/mod_final/validation2_mod.rds")
