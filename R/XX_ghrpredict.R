...
form <- paste(
  "casos ~ 1 ",
  cov_varying("tas6.l1", pattern = "", unit = "koppen_id"),
  cov_varying("tasan6.l1", pattern = "", unit = "koppen_id2"),
  cov_varying("spei3.l1", pattern = "", unit = "koppen_id3"),
  cov_varying("spei12.l1", pattern = "", unit = "koppen_id4"),
  re_s, re_w, re_y,
  sep = " + "
)
form  
...
saveRDS(pred_mod, "output/OOS/test.rds")
